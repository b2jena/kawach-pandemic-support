...
public class MedicalSosRequestServiceImpl implements MedicalSosRequestService {
  ...
  Logger logger = LoggerFactory.getLogger(
    MedicalSosRequestServiceImpl.class.getName()
  );
  ...
  @Autowired
  public MedicalSosRequestServiceImpl(
    MedicalSosRequestRepository medicalSosRequestRepository
  ) {
  ...
  public List<MedicalSosRequest> getMedSOS() {
    ...
    List<MedicalSosRequest> request = mongoTemplate.find(
      query,
      MedicalSosRequest.class
    );
    return request;
  }
  ...
  public List<MedicalSosRequest> getBedSOS() {
    Query query = new Query(
      Criteria.where("requestStatus").is("Bed").and("formStatus").is("OPEN")
    );
    List<MedicalSosRequest> request = mongoTemplate.find(
      query,
      MedicalSosRequest.class
   ...
   * Only the sos whose status is open is fetched. These sos requests are fetched randomly.
   */
  @Override
  public MedicalSosRequest getSOSMed() {
    ...
    List<MedicalSosRequest> sos = mongoTemplate.find(
      query,
      MedicalSosRequest.class
    );
  ...
  /**
   * This method is used to fetch single sos whose type is bed and form status in open.
   * Only the sos whose status is open is fetched. These sos requests are fetched randomly.
   */
  @Override
  ...
  /**
   * This method contains the logic for updating the MedicalSosRequest status to close.
   */
  @Override
